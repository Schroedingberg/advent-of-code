...
Download from https://github.com/aaronmeinel/aoc2025
...
Run the project directly, via `:main-opts` (`-m aaronmeinel.aoc2025`):
...
Run that uberjar:
    ...
    $ java -jar target/aoc2025-0.1.0-SNAPSHOT.jar
